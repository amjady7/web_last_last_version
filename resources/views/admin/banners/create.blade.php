...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-white mb-6">Create New Banner</h1>

        <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data"        class="bg-gray-800 border border-gray-700 shadow-lg rounded-xl p-6">
            @csrf

            <!-- Title -->
            <div class="mb-5">
                <label for="title" class="block text-sm font-semibold text-blue-400">Title</label>
            ...
            <!-- Link (optional) -->
            <div class="mb-5">
                <label for="link" class="block text-sm font-semibold text-blue-400">Link (optional)</label>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit"
                    class="ml-3 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition font-semibold">Create Banner</button>
            </div>
        </form>
    </div>
</div>
