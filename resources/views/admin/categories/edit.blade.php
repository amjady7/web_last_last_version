...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="bg-gray-800 border border-gray-700 shadow-lg rounded-xl p-6">
            @csrf
            @method('PUT')
            ...
            @if($category->image)
            <div class="mb-5">
                <label class="block text-sm font-semibold text-blue-400">Current Image</label>
                <div class="mt-2">
            ...
            <!-- New Image -->
            <div class="mb-5">
                <label for="image" class="block text-sm font-semibold text-blue-400">New Image (optional)</label>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit"
                    class="ml-3 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition font-semibold">Update Category</button>
            </div>
        </form>
    </div>
</div>
