                    ...
                    <div class="bg-white rounded-lg shadow p-4">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-xs text-gray-900">{{ $order->created_at->format('M d, Y') }}</p>
                            </div>
                        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 hidden md:table">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-900 uppercase tracking-wider">Customer</th>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-900 uppercase tracking-wider">Payment</th>
